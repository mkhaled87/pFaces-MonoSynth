...
// Function 1: check_safe_set
#define KERNEL_SAFESET_CHECK_FUNC_NAME "check_safe_set"
#define KERNEL_SAFESET_CHECK_FUNC_IDX 1
#define KERNEL_SAFESET_CHECK_FUNC_NUM_ARGS 4
#define KERNEL_SAFESET_CHECK_FUNCARG_BASIS_BAG 0
#define KERNEL_SAFESET_CHECK_FUNCARG_UNSAFE_BAG 1
#define KERNEL_SAFESET_CHECK_FUNCARG_COUNTERS_BAG 2
#define KERNEL_SAFESET_CHECK_FUNCARG_RO_PARAMS 3
